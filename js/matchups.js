...
// ============================================================================
const MATCHUPS = {
  'priest_berserker':94, 'priest_wizard':4, 'priest_knight':80, 'priest_sapper':80, 'priest_archer':38,
  ...
  'berserker_wizard':62, 'berserker_knight':87, 'berserker_sapper':29, 'berserker_archer':31, 'berserker_jester':44,
  ...
  'wizard_sapper':92, 'wizard_archer':97, 'wizard_jester':3, 'wizard_cannoneer':72, 'wizard_duelist':13,
  'wizard_necromancer':1, 'wizard_reaper':0, 'wizard_ronin':53, 'wizard_witch':94, 'wizard_hunter':72,
  'wizard_warlock':36, 'wizard_gambler':91, 'knight_sapper':14, 'knight_archer':13, 'knight_jester':68,
  ...
  'sapper_jester':100, 'sapper_cannoneer':9, 'sapper_duelist':88, 'sapper_necromancer':26, 'sapper_reaper':93,
  'sapper_ronin':45, 'sapper_witch':25, 'sapper_hunter':40, 'sapper_warlock':19, 'sapper_gambler':27,
  'archer_jester':10, 'archer_cannoneer':85, 'archer_duelist':81, 'archer_necromancer':32, 'archer_reaper':97,
  'archer_ronin':49, 'archer_witch':27, 'archer_hunter':70, 'archer_warlock':15, 'archer_gambler':29,
  'jester_cannoneer':79, 'jester_duelist':58, 'jester_necromancer':9, 'jester_reaper':14, 'jester_ronin':47,
  'jester_witch':80, 'jester_hunter':77, 'jester_warlock':1, 'jester_gambler':78, 'cannoneer_duelist':56,
