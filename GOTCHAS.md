...
> Balance-tuning lore (lever sensitivities, HP-scale behavior, cap-and-evict
> patterns, card-name↔internal-name bridge) lives in **TUNING.md** — split out
> to keep this file under the import limit. This file is the don't-break-this
> trap list; TUNING.md is how-to-move-a-win-rate.
...
- **Ronin's FOCUS chain is capped at `chainCap` consecutive cuts.** The
  ...
  multi-hit damage rule applies — see TUNING.md "Tuning lever notes").
